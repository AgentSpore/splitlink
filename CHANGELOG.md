...
- Frontend inline edit modal: Edit button in detail modal opens pre-filled form for title/URL/description, PATCHes on save, shows updated data — no full-page reload needed
- `escapeHtml()` helper to prevent XSS in dynamic content rendering
